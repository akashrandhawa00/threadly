    ...
    return (
        <div className="relative group">
            ...
            <Link to={`/post/${post.id}`} className="block relative z-10">
                <div className="w-80 h-76 bg-zinc-900/80 border border-white/20 rounded-2xl text-white flex flex-col p-5 overflow-hidden transition-colors duration-300 group-hover:bg-gray-800">
